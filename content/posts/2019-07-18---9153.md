...
description: "유전체의 두께와 게이트 누설 전류간의 관계 이해 및 유전체 재료에 따른 누설 전류 변화 분석"
---
...
Where, 
- $\phi_{\mathrm{S}}$ : surface potential
- $\mathrm{K}_{\mathrm{s}}$ : dielectric constant of semiconductor
- $\mathrm{K}_{o}$ : dielectric constant of oxide
- $\mathrm{C}_{\mathrm{s}}$ : semiconductor capacitance
- $\mathrm{C}_{\mathrm{o}}$ : oxide capacitance
...
- At low frequency
  - Electron generation rate can follow ac gate voltage
  - Recover original capacitance after inversion


- At high frequency
   - Electron generation rate cannot follow ac gate voltage
   - Reduced capacitance after inversion
...
![Aspect ratio](/media/POST/9153/6_1.jpg)
...
[Software of analyzing the characteristic of nano MOS element](https://www.edison.re.kr/web/nano/scienceappstore/-/scienceapp/mos1d/1-0-0/view)
...
10. Doping Concentration of Substrate: in unit of (cm^-3)
    - Only p-type substrate is available. (Because inversion layer electron tunneling from substrate to gate is region of interest.)
11. Gate Material
    - Poly-Si: Poly-Silicon gate
    - Metal: Metal gate (#12 parameter is adjustable.) 
12. Gate Workfunction: Work function of gate metal (activate only if #11 is Metal)
...
-Visualize using oneD plot program within the [Edison Nanophysics Website ](http://www.edison.re.kr/web/nano )
